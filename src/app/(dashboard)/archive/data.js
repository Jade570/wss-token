...
const Data = {
  queer: {
    ...
    subtitle:"Living itself is a struggle. But is it a luxury merely to dream of a happy life?",
    date: "1999.11.12~",
  ...
  stellar: {
    ...
    subtitle:"As a country bumpkin who had just arrived in Seoul, I turned away from the crowd gathered in Gwanghwamun Square simply out of fear. That decision has always weighed on me with a deep sense of guilt.",
    date:"2017.03.31",
  ...
  sewol: {
    ...
    subtitle:"They were only two years older than me. I had to watch people I loved suffer from the trauma and endure the indifference and mockery of others.",
    date:"2014.04.16",
  ...
  osong: {
    ...
    subtitle:"It is a neighboring town, less than an hour's drive from my home, and it's where my friend lives. And we will continue to experience extreme downpours due to the climate crisis. We simply cannot afford to lose people every time.",
    date:"2023.07.15",
  ...
  aricell: {
    ...
    subtitle:"There are no nations when it comes to human life and rights; our lives are all interconnected without exclusive barriers. How foolish I was, living overseas, to otherize 'them'.",
    date:"2024.06.24",
  ...
  itaewon: {
    ...
    subtitle:"My peers were crushed to death there. I, too, cherished Itaewon for its vegan restaurants and jazz bars.",
    date:"2022.10.29",
