  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Osong underpass tragedy, and the Aricell battery factory fire. These
        were all catastrophic events in which countless people lost their lives
        - disasters that could have been prevented, should never have occurred,
        and were all caused by human actions.
      </p>
    </div>
  );
}
